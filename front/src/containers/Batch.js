    ...
    if (
      ...
      if (
        ...
        this.setState({
          ...
          notifyOptions: {
            body:
              "Hung jury! You were not able to agree in time, so your jury was hung.\n",
            lang: "en",
            dir: "ltr"
          }
        });
      ...
      <div className="chat">
        <div className="chat__readingPeriod" style={{ marginLeft: 10 }}>
          {task.readingPeriods && task.readingPeriods.length && (
            <div
              className="chat__dialog-pinned-message"
