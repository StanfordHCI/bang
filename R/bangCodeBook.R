...
xtabs(repeatTeam ~ unlist(conditionm results.condition), data=stats, prop.table(repeatTeam)) 
...
df1 <- plyr::ddply(stats, .(batch, round, room), summarise, n=n(), prop = sum(repeatTeam)/n)
