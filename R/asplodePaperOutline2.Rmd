...
```{r mylatextable, results = "asis"}
stargazer(conditionalProbBaseline, type = 'text', title="Conditional fracture probability for baseline")
```
...
normalizedBaselineChange <- baselineFractureAbsSum/nrow(baselineFracture)
