...
# R metaGraph
```{r}
individualProportionFracture$correctAnswers <- sum(ifelse(individualProportionFracture$metaGuessedCorrectly==individualProportionFracture$blacklistMeta,1,0))
