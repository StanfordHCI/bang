...
rm(list=ls())
setwd("/Users/allieblaising/Desktop/bang_files/") # Change this to your working directory where Bang/R file is located
getwd()
dataPath = "../.data"
...
usersRounds <- users %>% mutate(id = as.character(id), batch=as.numeric(batch), round=as.numeric(round), room=as.character(room))
