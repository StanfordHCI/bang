...
# R metaGraph
```{r}
chanceAccuracy <- sum(individualProportionFracture$fracture == 0)/nrow(individualProportionFracture)
chanceAccuracy
accuracy <- sum(individualProportionFracture$metaGuessedCorrectly) / nrow(individualProportionFracture)
accuracy
metaAnswersSE <- sqrt(accuracy*(1-accuracy)/nrow(individualProportionFracture))
