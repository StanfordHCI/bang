...
manipulationCheck <- roundsWithRooms %>% 
  ...
  select(id, batch, room, round, results.manipulation, results.manipulationCheck.1, results.format)
...
data <- manipulationCheck %>%
  ...
  select(-manipulationCheck.1, -manipulationCheck.x, -manipulationCheck.y, -blacklist.x, -blacklist.y, -rooms.x, -rooms.y)
