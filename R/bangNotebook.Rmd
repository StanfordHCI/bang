...
## Probability of fracture given condition:
tally(~fracture | results.condition, data = groupedProportionFracture, format = "proportion")
```
...
```
## Absolute value in change in fracture proportions between unmasked and masked conditions: 
```{r}
treatmentFracture$abs <- abs(treatmentFracture1$prop1-treatmentFracture2$prop2)
...
g + geom_histogram(bins=7, 
                   col="pink", 
                   size=.4) + 
  labs(title="Absolute value of change in team fracture proportions in control condition", 
       fill = "Round") + 
  xlab(label="Absolute value of change in team fracture proportions in control condition") + 
  ylab(label="Count") 
