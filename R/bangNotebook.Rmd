...
ggplot(fracture, aes(prop, prop1)) +
  geom_point() +
  geom_jitter() + coord_fixed() + xlim(0,1) + ylim(0,1) + labs(subtitle="Proportion of fracture in ", 
       x="Fracture in round A: the first time a team interacts" + 
       y="Fracture in round Ap: the second time a team interacts, without knowing it") 
