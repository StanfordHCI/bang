...
ggplot(data=groupedProportionFractureLE, aes(prop, prop1)) + 
  geom_histogram(breaks=seq(0, 1, by=0.20), 
                 col="red", 
                 fill="green", 
                 alpha=.2) + labs(title="Team fracture in first round vs. third in learning effect condition n=7-8", 
                                  x="Fracture proportion
                                  1=Yes , 0=No", y="Count") + facet_grid(round ~ results.condition) 
...
ggplot(data=groupedProportionFractureLE, aes(prop)) + 
  geom_histogram(breaks=seq(0, 1, by=0.20), 
                 col="red", 
                 fill="green", 
                 alpha=.2) + labs(title="Team fracture in the first round vs. the third round in the learning effect condition, n= ", 
                                  x="Fracture proportion
                                  1=Yes , 0=No", y="Count") + facet_grid(round ~ results.condition) 
...
```{r}
ggplot(data=groupedProportionFracture, aes(factor(fracture))) + 
...
ggplot(data=groupedProportionFractureControl, aes(factor(fracture))) + 
  geom_bar(breaks=seq(0, 1, by=0.20), 
                 col="red", 
                 fill="green", 
                 alpha=.2) + labs(title="Fracture ratios: control round") + facet_grid(condition ~ results.condition)

ggplot(data=groupedProportionFractureLE, aes(factor(fracture))) + 
  geom_bar(breaks=seq(0, 1, by=0.20), 
                 col="red", 
                 fill="green", 
