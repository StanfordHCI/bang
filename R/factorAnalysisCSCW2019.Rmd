---
title: "Factor analysis; n=2, round=2"
...
## to-do, add more cleaning for viability 
...
```{r}
data = # viability survey results based on above conditions 
...
mydata = # viability survey results based on above conditions 
