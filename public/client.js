    ...
    if (URLvars.assignmentId === "ASSIGNMENT_ID_NOT_AVAILABLE") {
        ...
        if (waitChatOn) {
            ...
            addChatMessage({
                ...
                message: "You must be able to stay for the duration of this task, around 1 hour and 15 minutes. If you cannot stay for the entire time, please leave now. You will not be compensated if you leave preemptively. As a reminder, please do not refresh or close the page."
            });
            setTimeout(() => {
                addChatMessage({
                    username: botUsername,
