...
let SurveySchema = new Schema(
	{
		...
		questions: [ { result: { type: String, required: false }, type: {type:Number}, result_array: [{type: Number}] , number: Number, teammate: { type: mongoose.Schema.Types.ObjectId, ref: 'User' } } ],
		mainQuestion: {
			//Picking Rounds
			expRound1: Number,
			expRound2: Number,
