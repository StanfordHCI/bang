...
io.on('connection', (socket) => {
  ...
  socket.on('disconnect', () => {
    ...
    useUser(socket,user => {
      ...
      mturk.notifyWorkers([user.mturkId], "Did you mean to disconnect?", "It seems like you've disconnected from our HIT. If this was a mistake, please email us immediately at scaledhumanity@gmail.com with your Mturk ID and the last things you did in the HIT.")
