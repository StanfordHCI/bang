...
const launchBang = (callback) => {
    ...
    let HITTitle = 'Participate in a mock jury - bonus up to $' + (hourlyWage) + ' / hour (' + time + ')';
    let description = 'Work in groups to reach a decision on 3 jury cases. This task will take approximately ' + Math.round((roundMinutes * numRounds) + 10) + ' minutes. There will be a compensated waiting period, and if you complete the entire task you will receive a bonus of $' + bonusPrice + '.';
    ...
    let keywords = 'mock, jury, discussion, case, decision, sentence';
    ...
    setTimeout(() => {
        if (hitsLeft > 0 && !taskStarted) {
            ...
            let params2 = {
                Title: HITTitle,
                Description: 'Work in groups to reach a decision on 3 jury cases. This task will take approximately ' + Math.round((roundMinutes * numRounds) + 10) + ' minutes. There will be a compensated waiting period, and if you complete the entire task you will receive a bonus of $' + bonusPrice + '.',
                ...
                Keywords: 'mock, jury, discussion, case, decision, sentence',
