...
const launchBang = (callback) => {
    ...
    let HITTitle = 'Solve interesting problems - bonus up to $' + (hourlyWage) + ' / hour (' + time + ')';
    let description = 'Work in groups to solve challenging problems. This task will take approximately ' + Math.round((roundMinutes * numRounds) + 10) + ' minutes. There will be a compensated waiting period, and if you complete the entire task you will receive a bonus of $' + bonusPrice + '.';
    ...
    let keywords = 'problem, solving, intellective, task';
    ...
    setTimeout(() => {
        if (hitsLeft > 0 && !taskStarted) {
            ...
            let params2 = {
                Title: HITTitle,
                Description: 'Work in groups to solve challenging problems. This task will take approximately ' + Math.round((roundMinutes * numRounds) + 10) + ' minutes. There will be a compensated waiting period, and if you complete the entire task you will receive a bonus of $' + bonusPrice + '.',
                ...
                Keywords: 'problem, solving, intellective, task',
